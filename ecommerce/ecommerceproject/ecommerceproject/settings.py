...
SECRET_KEY = 'django-insecure--cla3zvd4kgd(xw1v03baqqxo8!(1zy1my(dk9xs961#rzjau#'
...
# Corrected STATIC_URL with a leading slash
STATIC_URL = '/static/'

# Corrected STATICFILES_DIRS path relative to BASE_DIR
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]


# Make sure MEDIA_URL and MEDIA_ROOT are correctly configured
MEDIA_URL = '/media/'
